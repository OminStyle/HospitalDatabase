...
$sql="
    SELECT	d.DName, Min(a.Age) as youngest FROM Disease d, Assigned_Patient  a. Diagnose di, HospitalStaff h WHERE	d.DID = di.DID and a.PID = di.PID and di.HSID = h.HSID
