      ...
      <div class="jumbotron">
        ...
        <form>
            <select name="Queries" onchange="showQueryOptions(this.value)">
                ...
                <option value="Query10">10. For each disease, find age of oldest Patient diagnosed by experienced doctor</option>
                <option value="Query11">11. Remove Disease</option>
                <option value="Query12">12. For each disease, find age of youngest Patient diagnosed by experienced doctor</option>
            </select>
        </form>
      <br>
